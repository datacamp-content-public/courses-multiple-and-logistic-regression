...
`@script`
Either you love japanese beaches but are just afraid of Wolf spiders, or you love nature and you want to save wolf spiders from going extinct.
...
`@script`
Either case, a linear model is needed in order to help you find out if the beach you plan to go to is inhabited by Wolf spiders or not,; or what would be the kind of sand that the Wolf spiders thrive and survive extinction. Lucky you, the job has already been half done! A team of Japanese researchers had investigated what would cause wolf spider to be found on a beach. They went to 28 beaches in Japan, measured the average sand grain size (in millimetres), and observed the presence or absence of this particular spider on each beach.
