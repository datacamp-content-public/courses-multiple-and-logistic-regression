...
`@script`
The wolf spider data will be useful for us in creating a linear model to help you make decisions if one day during one summer you decided to travel to Japan but you have no particular idea what to do either to visit the sandy beaches to go for swimming and sunbathing or just for nature conservation.
