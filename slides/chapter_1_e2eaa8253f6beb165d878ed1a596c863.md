...
`@script`
The linear regression model would predict the presence of Wolfspiders, which in contrast in logistic regression model would predict the absence of Wolfspiders.
